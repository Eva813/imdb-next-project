  ...
  return (
    ...
    <div className='max-w-6xl mx-auto p-3 space-y-4'>
      ...
      <p >
        ...
        and trailers.<span className="text-rose-600"> Our movie database is constantly updated with new
        releases, ensuring that you have access to the latest and greatest in
        the world of cinema.</span> You can search for movies by title, director,
